 ...
 */
    ...
    function calculate() {
        ...
        basicMoney.innerHTML = ":"+((parseInt(latelyWages) + latelyWages * averageNumber) / 2 * payMonth /12* 0.01).toFixed(3)+"元";
        accountMoney.innerHTML = ":"+(accountBalance/CalculateMonth).toFixed(3)+"元";

        if(build>work){
            limboMoney.innerHTML = ":"+(latelyWages * averageNumber *0.013*difference/12).toFixed(3)+"元";
            totalMoney.innerHTML = ":"+(parseFloat(((parseInt(latelyWages) + latelyWages * averageNumber) / 2 * payMonth /12* 0.01).toFixed(3))+parseFloat((latelyWages * averageNumber *0.013*difference/12).toFixed(3))+parseFloat(accountBalance/CalculateMonth).toFixed(3))+"元";}

    else{
            limboMoney.innerHTML = ":"+0.000+"元";
            totalMoney.innerHTML = ":"+(parseFloat((parseInt(latelyWages) + latelyWages * averageNumber) / 2 * payMonth /12* 0.01).toFixed(3))+parseFloat((accountBalance/CalculateMonth).toFixed(3))+"元";
        }
